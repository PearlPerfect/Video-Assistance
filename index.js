...
const btnExplanation = [
  { content: "Schools is basically divided into Primary, Secondary and Tetiary schools." },
  { content: "we have about 170 Universities in Nigeria" },
  { content: "Each University has a specific Number of faculty" },
  { content: "While each faculty has different Departments" },
];
